...
def main(model=None, tokenizer=None, argv=None, directly_return=False):
    ...
    parser.add_argument("--bert_model", type=str, required=model is None or tokenizer is None, help="Bert pre-trained model selected in the list: bert-base-uncased, "
