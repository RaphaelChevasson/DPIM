"""modification: just force saving checkpoint every power of two iterations"""
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if (is_power_of_two(global_step) or global_step % args.output_step == 0) and args.local_rank in [-1, 0]:
